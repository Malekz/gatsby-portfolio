...
excerpt: Most people just put super(props) as it will make no harm to code and there is no time in the earth to know the reason why the thing is working, just let it be.
---

<!-- https://overreacted.io/why-do-we-write-super-props/ -->

I know [Hooks](https://reactjs.org/docs/hooks-intro.html) are the new hotness. Ironically, I want to start this blog by describing fun facts about class components. How about that!
