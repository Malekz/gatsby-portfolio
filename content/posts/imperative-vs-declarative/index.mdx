...
excerpt: Your enemy is not object-oriented programming.
---

<!-- https://codeburst.io/declarative-vs-imperative-programming-a8a7c93d9ad2 -->

If you’ve read the [React](https://reactjs.org/) docs, you probably have seen that React is declarative. This is normally the type of thing I skip over — a not so good habit of mine. (Give me the code samples already!) But as someone who started learning React soon out of college, I was often thinking about problems incorrectly.
...
According to The [Information](https://en.wikipedia.org/wiki/Imperative_programming):
...
- Avoid Refs. Sure, sometimes they’re necessary, but if you feel yourself reaching for refs then it can often mean you’re doing something wrong. (There are some legitimate uses for refs in the [React docs](https://reactjs.org/docs/refs-and-the-dom.html)).
